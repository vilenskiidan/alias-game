...
const useGameStore = () => {
  ...
  const sampleWords = [
    'כלב', 'חתול', 'בית', 'מכונית', 'ספר', 'מחשב', 'טלפון', 'עץ', 'פרח', 'ים',
    'הר', 'שמש', 'ירח', 'כוכב', 'אוכל', 'מים', 'אש', 'רוח', 'גשם', 'שלג',
    'כדור', 'משחק', 'חבר', 'משפחה', 'בית ספר', 'עבודה', 'חופש', 'נסיעה', 'ספורט', 'מוזיקה',
    'ריקוד', 'סרט', 'ספר', 'צבע', 'מספר', 'זמן', 'מקום', 'דבר', 'אדם', 'ילד'
  ];
